...
parser.add_argument('--activate_regular_restrictions', type=int, default=3, help=" 0:relu 1:relu 0.5 2:sigmoid 3:arcl1 ")
parser.add_argument('--loss_align', type=int, default=1, help="0:GDLK 1:short 2:long")

parser.add_argument('--ab', type=int, default=0, help="0 1 2 3")
